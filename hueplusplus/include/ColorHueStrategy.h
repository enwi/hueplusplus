...
{
public:
    //! \brief Virtual function for changing a lights color in hue with a specified transition.
    //!
    ...
    //! \brief Virtual function for changing a lights color in saturation with a specified transition.
    //!
    ...
    //! \brief Virtual function for changing a lights color in hue and saturation format with a specified transition.
    //!
    //! The hue ranges from 0 to 65535, whereas 65535 and 0 are red, 25500 is green and 46920 is blue.
    //! The saturation ranges from 0 to 254, whereas 0 is least saturated (white) and 254 is most saturated (vibrant).
    //! \param hue The hue of the color
    ...
    //! \brief Virtual function for changing a lights color in CIE format with a specified transition.
    //!
    ...
    //! \brief Virtual function for changing a lights color in rgb format with a specified transition.
    //!
    ...
    //! \brief Virtual function for turning on/off the color loop feature of a light.
    //!
    ...
    //! \brief Virtual function that lets the light perform one breath cycle in the specified color.
    //!
    //! The hue ranges from 0 to 65535, whereas 65535 and 0 are red, 25500 is green and 46920 is blue.
    //! The saturation ranges from 0 to 254, whereas 0 is least saturated (white) and 254 is most saturated (vibrant).
    //! \param hue The hue of the color
