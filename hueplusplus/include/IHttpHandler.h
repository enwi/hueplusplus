...
public:
  ...
  //!
  //! It should return a string containing the response of the host.
  ...
  //!
  //! It should return a vector containing all responses the multicast request got back
  ...
  //! \brief Virtual function that should send a HTTP GET request to the specified host and return the body of the response.
  //!
  //! It should return a Json::Value parsed from the body of the response of the host.
  //! Note body can also be left empty!
  //! \param uri String that contains the uniform resource identifier
