...
protected:
        ...
        test_bridge(getBridgeIp(), getBridgeUsername(), handler)
    {
        ...
        hue_bridge_state["lights"]["2"]["swupdate"] = Json::Value(Json::objectValue);
        hue_bridge_state["lights"]["2"]["swupdate"]["state"] = "noupdates";
        hue_bridge_state["lights"]["2"]["swupdate"]["lastinstall"] = Json::nullValue;
        ...
        hue_bridge_state["lights"]["3"]["swupdate"] = Json::Value(Json::objectValue);
        hue_bridge_state["lights"]["3"]["swupdate"]["state"] = "noupdates";
        hue_bridge_state["lights"]["3"]["swupdate"]["lastinstall"] = Json::nullValue;
...
TEST_F(HueLightTest, MiredToKelvin)
{
    ...
    EXPECT_EQ(6024, test_light_3.MiredToKelvin(166));   // 6000 kelvin should be 166 mired, but keep in mind flops are not exact
}
...
TEST_F(HueLightTest, getColorHueSaturation)
{
    ...
    EXPECT_EQ(std::make_pair(static_cast<uint16_t>(123456), static_cast<uint8_t>(123)), ctest_light_2.getColorHueSaturation());
    EXPECT_EQ(std::make_pair(static_cast<uint16_t>(123456), static_cast<uint8_t>(123)), ctest_light_3.getColorHueSaturation());
    EXPECT_EQ(std::make_pair(static_cast<uint16_t>(0), static_cast<uint8_t>(0)), test_light_1.getColorHueSaturation());
    EXPECT_EQ(std::make_pair(static_cast<uint16_t>(123456), static_cast<uint8_t>(123)), test_light_2.getColorHueSaturation());
    EXPECT_EQ(std::make_pair(static_cast<uint16_t>(123456), static_cast<uint8_t>(123)), test_light_3.getColorHueSaturation());
}
