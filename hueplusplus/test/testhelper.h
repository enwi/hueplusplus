...
const std::string bridge_id = "111111FFFE11E111";
const std::string bridge_uuid = "1f111f11-da11-11e1-1b11-11111111e111";
const std::string bridge_mac = "11111111e111";

const std::string brige_xml = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>"
...
const std::vector<std::string> multicast_reply = {
  "HTTP/1.1 200 OK\r\n"
  ...
  "USN: uuid:0f0000b0-f0da-0ad0-00b0-0000000fdf00::urn:schemas-upnp-org:device:InternetGatewayDevice:1",
  ...
  "USN: uuid:0f0000b0-f0da-0ad0-00b0-0000000fdf00::urn:schemas-upnp-org:service:Layer3Forwarding:1",
  ...
  "USN: uuid:0f0000b0-f0da-0ad0-00b0-0000000fdf00::urn:schemas-upnp-org:device:WANDevice:1",
  ...
  "USN: uuid:0f0000b0-f0da-0ad0-00b0-0000000fdf00::urn:schemas-upnp-org:service:WANCommonInterfaceConfig:1",
  ...
  "USN: uuid:0f0000b0-f0da-0ad0-00b0-0000000fdf00::urn:schemas-upnp-org:device:WANConnectionDevice:1",
  ...
  "USN: uuid:0f0000b0-f0da-0ad0-00b0-0000000fdf00::urn:schemas-upnp-org:service:WANIPConnection:1",
