...
{
    return "192.168.2.116";                         //!< IP-Address of the fake hue bridge in dotted decimal notation like "192.168.2.1"
}

inline std::string getBridgeUsername()
{
    return "83b7780291a6ceffbe0bd049104df";	  //!< Username that is ussed to access the fake hue bridge
}
