...
## Creating the Hue bridge {#creating-bridge}
To start searching for a Hue Bridge you will need to choose an IHttpHandler and create one.
[HttplibHttpHandler](@ref hueplusplus::HttplibHttpHandler) is recommended because it is cross-platform and supports HTTPS.
...
where index is your preferred Bridge from the part [Creating the Hue bridge](#creating-bridge). This requires the user to press the link button.
